  ...
  return (
    ...
    >
      ...
      <View style={styles.characterBody}>
        ...
        <View
          style={[
            styles.pixelRow,
            styles.body,
            { backgroundColor: equipment.armor.color },
          ]}
        >
          <View
            style={[styles.pixel, { backgroundColor: equipment.armor.color }]}
          />
          <View
            style={[styles.pixel, { backgroundColor: equipment.armor.color }]}
          />
        ...
        <View style={styles.pixelRow}>
          ...
          <View
            style={[
              styles.pixel,
              styles.arm,
              { backgroundColor: equipment.weapon.color },
            ]}
          />
        </View>
      ...
      <View style={styles.equipment}>
        <Text
          style={[styles.equipmentEmoji, { fontSize: dimensions.emoji * 0.6 }]}
        >
        ...
        {equipment.accessory && (
          <Text
            style={[
              styles.equipmentEmoji,
              { fontSize: dimensions.emoji * 0.5 },
            ]}
          >
      ...
      <View style={styles.levelBadge}>
        <Text style={[styles.levelText, { fontSize: dimensions.text }]}>
          LV {level}
        </Text>
      </View>
    </View>
